...
#
#  $ bin/test -s intk.vanabbe -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src intk.vanabbe.testing.INTK_VANABBE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/intk/vanabbe/tests/robot/test_example.robot
#
